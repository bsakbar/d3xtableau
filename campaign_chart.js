  ...
  function resetFilters() {
    ...
    function drawDotChart(arr) {
      ...
      $('#wrapper_partner').empty();
        ...
        const wrapper = d3.select("#wrapper_partner")
            .append("svg")
        ...
        dots.on("mouseover", function(d) {
                ...
                div.html(d.campaign + "<br/>" + "Impressions: " + add_commas(d.impressions) + "<br/>" + "Media Spend: $" + add_commas(Math.round(d.media_spend)) + "<br/>" + "CPA: $" + add_commas(Math.round(d.cpa)))
